...
* [KeepUp data science challenge](https://github.com/vincelaird/springboard/blob/master/keepup_challenge/KeepUp.ipynb) - analysis of Amazon dataset to determine methods 
